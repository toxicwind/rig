...
// ── LlamaSwap ─────────────────────────────────────────────────────
/// LlamaSwap OpenAI-compatible endpoint (upstream default port 8080).
/// Point at a non-default instance via `LLAMA_SWAP_BASE_URL` / `LLAMA_SWAP_HOST`.
pub const LLAMA_SWAP_BASE_URL: &str = "http://localhost:8080/v1";
