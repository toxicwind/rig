...
// ── LlamaSwap ─────────────────────────────────────────────────────
/// LlamaSwap OpenAI-compatible endpoint (herd multiplexer on :25100).
/// Point at a different instance via `LLAMA_SWAP_BASE_URL` / `LLAMA_SWAP_HOST`.
pub const LLAMA_SWAP_BASE_URL: &str = "http://localhost:25100/v1";
